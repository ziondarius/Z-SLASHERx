...
ENEMY_ALERT_DISTANCE_MIN = 64  # 4 blocks
ENEMY_ALERT_DISTANCE_MAX = 96  # 6 blocks
ENEMY_ALERT_VERTICAL_TOLERANCE = 18
ENEMY_ALERT_LOST_MS = 2000
ENEMY_ALERT_SPEED_MULT = 1.9
ENEMY_ALERT_SHOOT_COOLDOWN = 60
SWORDSMAN_ATTACK_RANGE = 22
SWORDSMAN_LOST_MS = 2000
SWORDSMAN_CHASE_SPEED = 3.6
SWORDSMAN_JUMP_VELOCITY = -3.0
SWORDSMAN_JUMP_HEIGHT_LIMIT = 44
SWORDSMAN_LOS_VERTICAL_TOLERANCE = 48
SWORDSMAN_SWING_DURATION = 240
SWORDSMAN_SWING_COOLDOWN = 1000
SWORDSMAN_JUMP_COOLDOWN_MS = 750
